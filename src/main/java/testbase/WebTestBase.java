...
public class WebTestBase {
    ...
    public void initialization(){
        ...
        if(browserName.equals("chrome")){
            ...
            System.setProperty("webdriver.ie.driver",System.getProperty("user.dir")+"/src/main/resources/drivers/internetexplorerdriver.exe");
            driver=new InternetExplorerDriver();
        }else{
            System.out.println("please select a correct browser name");
        }
